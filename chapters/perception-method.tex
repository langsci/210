...
For /ŋ(g)/ and /k/ a further criterion was to have an equal number of words with the variable in \isi{intervocalic} and in \isi{word-final} position in order to match the most prominent phonological contexts that these variables were investigated in in production and to be able to discover any potential differences in \isi{priming} related to this criterion.
...
\begin{table}[h]
	\caption[Gender and \isi{social class} of subjects (perception)]{Gender and \isi{social class} distribution of subjects (perception, external)}
...
Subject was entered as a random intercept (cf. \ref{sec.prod_method.stats}), and a random by-subject slope for stimulus order was also included to counter any individual training or fatigue effects.
...
\isi{Collinearity} was investigated applying the functions written by Austin Frank (cf. \ref{sec.prod_method.stats}) to corresponding mixed-effects logistic regression models.