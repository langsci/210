...
Unfortunately, uncovering social \isi{attitude}s towards a particular phonetic-phonological feature is seldom a straightforward task.
...
And of course any \isi{exemplar} can be indexed with information that is somehow related to the wider context the experience was made in (cf. Section \ref{sec.sal.exemplar.basic}).
