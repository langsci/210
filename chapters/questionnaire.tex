\chapter{Questionnaire}
	...
	\begin{multicols}{2}
		\begin{itemize}
			...
			\item Is there a Liverpudlian\is{identity} sense of humour? What is it like?
		\end{itemize}
	\end{multicols}
	...
	\begin{multicols}{2}
		\begin{itemize}
			\item What would you call yourself (British, English, Northerner\is{identity}, \isi{Merseyside}r, Liverpudlian\is{identity}, Scouser\is{identity})? If several, in what order?
			\item How would you feel if someone called you a Scouser\is{identity}?
			\item What are Woolybacks? Where do they live?
			\item Plastic Scouser\is{identity}s?
			\item Scally Scouser\is{identity}?
	...
	\begin{multicols}{2}
		\begin{itemize}
			\item Do you think Liverpool has \isi{change}d in the last 20 years? For better or worse?
			...
			\item Do you, as a Liverpudlian\is{identity}, feel neglected by the central government? If yes, in what ways?
	...
	\section*{Liverpool's \isi{image}}
	\begin{multicols}{2}
		\begin{itemize}
			\item Are you familiar with the label “Livercool”? Do you think it is appropriate?
			\item Do you think Liverpool is stigmatise\is{stigmatisation}d in England/the United Kingdom?
			...
			\item Do you think the riots still form part of Liverpool's \isi{image} in the rest of the country?
	...
	\begin{multicols}{2}
		\begin{itemize}
			...
			\item Do you think Scouse has \isi{change}d in the last 20 years? How? 
			\item If yes, how do you evaluate this \isi{change}?
		\end{itemize}		
	\end{multicols}