...
With respect to the \textsc{nurse}-\textsc{square} \isi{merger}, however, \isi{conscious} and \isi{sub-conscious awareness} declines from the middle to the young generation, while \isi{lenition} of /k/ sees a steady and linear increase in \isi{salience} from the oldest to the youngest speakers.
