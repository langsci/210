...
The last combinations of predictors that can \rephrase{tell us something about}{shed light on } the (\isi{change} in) \isi{salience} of \textsc{nurse} are the two-way interaction of style and age, and the three-way interaction of style, age, and social class.
