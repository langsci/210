...
In line with the primary interest of this thesis, the focus will be on what patterns of usage, distributions across social groups, and explicit comments\is{overt commentary} and \isi{attitude}s tell us about the status of the variables under scrutiny here: That is to say whether they can best be classified as \isi{indicator}s, \isi{marker}s, or \isi{stereotype}s.
...
In this case, the \isi{style shifting} pattern would again be a result of two conflicting evaluations, or norms, that just happen to pull realisations in the same direction (cf. \ref{prod.disc.happy.style}).
...
Lenition of /k/ attracts, by far, the largest number of explicit comments\is{overt commentary} and evaluations in my sample, which is clear evidence for the fact that it is considerably more salient\is{salience} than the other three variables investigated in this thesis.
...
Norms and \isi{attitude}s towards Scouse therefore seem to have remained largely stable across the three generations of speakers investigated in this dissertation.
...
\begin{inparaenum}[(1)]
	...
	\item \textsc{nurse} shows a more detailed and more robust social distribution than both happ\textsc{y} and /ŋ(g)/, more consistent \isi{style shifting}, and, most importantly, it attracts at least a small amount of explicit commentary\is{overt commentary}, which is clear evidence for a considerably higher degree of sociolinguistic \isi{salience}.
