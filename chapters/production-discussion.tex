...
\largerpage
Plots of mean vowel realisations also \rephrase{unearthed}{revealed } interesting differences between the age groups in how \textsc{nurse} and \textsc{square} \isi{change} along the style continuum.
