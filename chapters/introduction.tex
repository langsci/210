...
Priming effects of the kind that \textcite{niedzielski1999} and \textcite{hayetal2006a} found would then be restricted to linguistic variables that are highly \isi{salient}, possibly even to those that have reached the level of \isi{conscious} awareness in the relevant \isi{speech community} (\emph{stereotypes} in \isi{Labovian} terminology).

The testing ground for this hypothesis is \isi{Scouse}, the variety of English spoken in the city of \isi{Liverpool} and parts of its immediate surroundings in the north-west of England.
There are several points which make \isi{Liverpool} English a good candidate for the present study:
\begin{inparaenum}[(1)]
...
The most important of these is that, for the present study, it is desirable to have a classification that is more fine-grained than the binary \isi{salient} vs. non-\isi{salient} one.
...
It is true that, in the 11 since Watson's claim, a number of linguistic studies focusing on \isi{Liverpool} have been published, but I would still argue that we know far more about many other varieties of English than we do about \isi{Scouse}.
As far as I am aware, for instance, there is still no complete descriptive account of \isi{Liverpool} English except \cite{knowles1973}, which is now quite dated and also clearly and explicitly \emph{not} a truly variationist study of the kind \textcite{watson2007} refers to.
