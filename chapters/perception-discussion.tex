...
\textcite{knowles1973} already found that /ŋ(g)/ is often realised as [ŋk] at the end of words in Liverpool (cf. \sectref{sec.var.con.ng}) and, while I did not code for this, these variants are also commonly found in my own data.
...
This is because the realisation of <ng> clusters as [ŋg] is not restricted to Scouse, but is actually found in an area that is roughly delimited by the cities of Liverpool in the west, Manchester in the east, and Birmingham in the south (cf. \sectref{sec.var.con.ng}).
...
It has been mentioned in \sectref{sec.perc_method.sentences} that the speaker from Manchester who recorded the stimuli also naturally produced [ŋg] realisations in the relevant carrier words.
...
The speaker recorded the sentences using her native [ŋg] realisation, but the plosive was cut from the material before it was used in the perception test (cf. \sectref{sec.perc_method.con}).
