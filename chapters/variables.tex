...
Just like the \isi{Lancashire} \isi{dialect}s it is derived from, Scouse was still rhotic in the 19\textsuperscript{th} century, but it has now lost all traces of this rhoticism \citep[cf.][149]{knowles1997} and is just like RP in this respect.
...
Some confusion as to which vowel should be used in which words exists, and hypercorrect\is{hypercorrection}ions and mistakes occur (\cite[286--287]{knowles1973} and \cite[83]{knowles1978}).
...
Concerning possible sources of this merger, \citet[128]{honeybone2007} mentions the \isi{dialect} of South \isi{Lancashire} as the most obvious candidate.
...
\parencite{honeybone2007} also lists a number of studies reporting similar mergers in several \isi{Irish} varieties.
